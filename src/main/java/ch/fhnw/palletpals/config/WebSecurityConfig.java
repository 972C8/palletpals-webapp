    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers("/api/profile", "/api/orders/**", "/api/shopping/**", "/api/user/newPassword").hasRole(UserType.USER.toString())
                .antMatchers("/api/profile", "/api/orders/**", "/api/shopping/**", "/api/user/newPassword").hasRole(UserType.Admin.toString())
