...
### User Stories
1.	As an insurance user, I want to have a Web app so that I can use it on different mobile devices and on desktop computers.
2.	As an insurance user, I want to see a consistent visual appearance so that I can navigate easily, and it looks consistent.
3.	As an insurance user, I want to use list views so that I can explore and read my business data.
4.	As an insurance user, I want to use edit and create views so that I can maintain my business data.
5.	As an insurance user, I want to create an account so that I can get access to the Web app.
6.	As an insurance user, I want to log-in so that I can authenticate myself.
7.	As an insurance user, I want to edit my profile so that my data is stored securely.
...
The `ch.fhnw.palletpals.data.domain` package contains the following domain objects / entities including getters and setters:

![](images/domain-model.png)

### Business Logic Design

The `ch.fhnw.palletpals.business.service` package contains classes of the following business services:
